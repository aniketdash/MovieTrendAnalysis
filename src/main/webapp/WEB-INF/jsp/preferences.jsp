...
<div class="header" id="main" margin-bottom:20px>
 ...
 <div class="showCharts" align="center"  margin-top: 50px width: 25%>
	<form id="contactForm1" action="#" th:action="@{/preference}" th:object="${movie}" method="post">
